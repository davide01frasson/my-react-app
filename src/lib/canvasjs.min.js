...
(function() {
  ...
  function Va(h, n, v) {
      "millisecond" === v ? h.setMilliseconds(h.getMilliseconds() + 1 * n) : "second" === v ? h.setSeconds(h.getSeconds() + 1 * n) : "minute" === v ? h.setMinutes(h.getMinutes() + 1 * n) : "hour" === v ? h.setHours(h.getHours() + 1 * n) : "day" === v ? h.setDate(h.getDate() + 1 * n) : "week" === v ? h.setDate(h.getDate() + 7 * n) : "month" === v ? h.setMonth(h.getMonth() + 1 * n) : "year" === v && h.setFullYear(h.getFullYear() + 1 * n);
      return h
  }
  function W(h, n) {
      var v = !1;
  ...
  function J(h, n, v, w, qa) {
      ...
      w.push([h, n, v, qa]);
      return h.addEventListener ? (h.addEventListener(n, v, qa),
      v) : h.attachEvent ? (w = function(n) {
          n = n || window.event;
  ...
  function gb(h) {
      if (h._menuButton)
          h.exportEnabled ? (ha(h._menuButton, {
              backgroundColor: h.toolbar.itemBackgroundColor,
              color: h.toolbar.fontColor
          }),
          Ka(h._menuButton),
          h._menuButton.title = h._cultureInfo.menuText) : ua(h._menuButton);
          ...
          J(h._menuButton, "mousemove", function() {
              ...
              0 >= navigator.userAgent.search("MSIE") && ha(h._menuButton.childNodes[0], {
  ...
  function hb(h) {
      if (!ib) {
          var n = !1
            , v = !1;
          "undefined" === typeof pa.Chart.creditHref ? (h.creditHref = ga("iuuqr;..b`ow`rkr/bnl."),
          h.creditText = ga("B`ow`rKR/bnl")) : (n = h.updateOption("creditText"),
  ...
  function va(h, n, v) {
      ...
      n.getAttribute("state") !== v && (n.setAttribute("state", v),
  ...
  function U(h, n, v, w, qa) {
      ...
      h = {};
      this.theme && s(this.parent) && s(n) && s(w) ? h = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[n]) && (null === w ? h = this.parent.themeOptions[n] : 0 < this.parent.themeOptions[n].length && (w = Math.min(this.parent.themeOptions[n].length - 1, w),
  ...
  var Ga = !1, S = {}, w = !!document.createElement("canvas").getContext, pa = {
      ...
      en: {}
  }, y = w ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Ea = w ? "Impact, Charcoal, sans-serif" : "Arial", za = {
  ...
  (function() {
      ...
      S._fTWm = function(h) {
          if ("undefined" === typeof S.pro.sCH && !bb)
              try {
                  var n = (new Date).getMonth() % 3, v, s, w = h[S.fSDec("buy")];
  ...
  var fb = function() {
    ...
    , ea = function(h, n, v) {
      ...
      for (S = F = K = J = N = 0; 0 < M.length; )
          ...
          "#" === n || "0" === n)
              ...
              "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? "," === n ? (K++,
              F = S,
              S = 0,
              0 < E.length && (v = y + v)) : v = 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? n.slice(1, n.length - 1) + v : n + v : (n = 0 > U ? n.replace("+", "").replace("-", "") : n.replace("-", ""),
      ...
      for (M = !1; 0 < H.length; )
          n = H.shift(),
          "#" === n || "0" === n ? 0 < h.length && 0 !== Number(h.join("")) ? (y += h.shift(),
          M = !0) : "0" === n && (y += "0",
          M = !0) : 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? y += n.slice(1, n.length - 1) : "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? y += n : (n = 0 > U ? n.replace("+", "").replace("-", "") : n.replace("-", ""),
    ...
    , Na = function(h) {
      ...
      v = h.offsetY) : h.layerX || 0 == h.layerX ? (n = h.layerX,
      v = h.layerY) : (n = h.pageX - h.target.offsetLeft,
    ...
    , bb = window && window[ga("mnb`uhno")] && window[ga("mnb`uhno")].href && window[ga("mnb`uhno")].href.indexOf && (-1 !== window[ga("mnb`uhno")].href.indexOf(ga("b`ow`rkr/bnl")) || -1 !== window[ga("mnb`uhno")].href.indexOf(ga("gdonqhy/bnl")) || -1 !== window[ga("mnb`uhno")].href.indexOf(ga("gheemd")))
  ...
  U.prototype.setOptions = function(h, n) {
      if (pa[this._defaultsKey]) {
          ...
          for (w in s)
              "publicProperties" !== w && s.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : n && w in n ? n[w] : s[w])
      } else
      ...
      if ("undefined" !== typeof h || this.options._isPlaceholder)
          ...
          this.isOptionsInArray) {
              ...
              var n = this.parent.options[this.optionsName]
                , s = n.length;
              this.options._isPlaceholder || (Ca(n),
              s = n.indexOf(this.options));
              this.options = "undefined" === typeof h ? {} : h;
              n[s] = this.options
          } else
              this.options = "undefined" === typeof h ? {} : h,
              h = this.parent.options,
              this.optionsName ? n = this.optionsName : (n = this._defaultsKey) && 0 !== n.length ? (s = n.charAt(0).toLowerCase(),
      ...
      if (0 !== this.fontSize) {
          ...
          for (s = 0; s < this._wrappedText.lines.length; s++) {
              ...
              if ("right" === this.horizontalAlign || "right" === this.textAlign)
                  ...
                  w = (this.width - (this.leftPadding + this.rightPadding)) / 2 - F.width / 2 + this.leftPadding;
  ...
  ia.prototype._getLineWithWidth = function(h, n, s) {
      ...
      s > n && 1 < E.length && (E = E.substr(0, E.length - 1),
      s = this.ctx.measureText(E).width);
      n = !0;
      if (E.length === h.length || " " === h[E.length])
          n = !1;
      n && (h = E.split(" "),
      1 < h.length && h.pop(),
      E = h.join(" "),
  ...
  ya.prototype.setLayout = function() {
      if (this.text) {
          var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, n = h.layoutManager.getFreeSpace(), w = n.x1, y = n.y1, F = 0, J = 0, E = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, N, H;
          "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = n.width - 4 - E * ("center" === this.horizontalAlign ? 2 : 1)),
          J = 0.5 * n.height - this.margin - 2,
          F = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = n.height - 4),
          ...
          M = J.measureText();
          "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (y = n.y1 + 2,
          H = "top") : "bottom" === this.verticalAlign && (y = n.y2 - 2 - M.height,
          H = "bottom"),
          ...
          this.width = M.width,
          this.height = M.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (w = n.x1 + 2,
          y = n.y2 - 2 - (this.maxWidth / 2 - M.width / 2),
          F = -90,
          H = "left",
          this.width = M.height,
          this.height = M.width) : "right" === this.horizontalAlign ? (w = n.x2 - 2,
  ...
  var Oa = {
      ...
      formatNumber: function(h, n, w) {
          w = w || "en";
          if (Ja[w])
              return ea(h, n || "#,##0.##", new Ia(w));
          throw "Unknown Culture Name";
      },
      formatDate: function(h, n, w) {
          w = w || "en";
          if (Ja[w])
              return Aa(h, n || "DD MMM YYYY", new Ia(w));
          throw "Unknown Culture Name";
      }
  };
  ...
  y = Oa.Chart = function() {
      ...
      function n(a, d, c) {
          ...
          w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ta(a, d),
      ...
      function y(a, d, c, b, e, f, l, t, B, k) {
          ...
          a.beginPath();
          B && 0 < t.thickness ? (a.moveTo(b - l.thickness / 2, Math.round((c + e) / 2) - p),
          a.lineTo(d + l.thickness / 2, Math.round((c + e) / 2) - p)) : 0 < t.thickness && (a.moveTo(Math.round((d + b) / 2) - p, c + l.thickness / 2),
          ...
          a.beginPath();
          B && 0 < l.thickness ? (a.moveTo(b - m, c),
          a.lineTo(b - m, e),
          a.moveTo(d + m, c),
      ...
      n.prototype.setLayout = function() {
              ...
              if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) {
                  if (!this.data[d].axisYType || "primary" === this.data[d].axisYType)
                      if (this.options.axisY && 0 < this.options.axisY.length) {
                          ...
                          this.axisY.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[0] = new E(this,"axisY",this.options.axisY,0,"axisY","left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[0] = new E(this,"axisY",this.options.axisY,0,"axisY","bottom"))),
                  ...
                  if ("secondary" === this.data[d].axisYType)
                      if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                          ...
                          this.axisY2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[0] = new E(this,"axisY2",this.options.axisY2,0,"axisY","right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[0] = new E(this,"axisY2",this.options.axisY2,0,"axisY","top"))),
                  ...
                  if (!this.data[d].axisXType || "primary" === this.data[d].axisXType)
                      if (this.options.axisX && 0 < this.options.axisX.length) {
                          ...
                          this.axisX.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[0] = new E(this,"axisX",this.options.axisX,0,"axisX","bottom")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[0] = new E(this,"axisX",this.options.axisX,0,"axisX","left"))),
                  ...
                  if ("secondary" === this.data[d].axisXType)
                      if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                          ...
                          this.axisX2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[0] = new E(this,"axisX2",this.options.axisX2,0,"axisX","top")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[0] = new E(this,"axisX2",this.options.axisX2,0,"axisX","right"))),
          ...
          this._zoomButton.style.borderRight = this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor,
          this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.buttonBorderThickness : 0) + "px solid " + this.toolbar.buttonBorderColor) : (ua(this._zoomButton, this._resetButton),
          ...
          for (d = 0; d < this.plotInfo.plotTypes.length; d++)
              for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                  var t = f.plotUnits[l]
                    , B = null;
                  t.targetCanvas = null;
                  this.animatedRender && (t.targetCanvas = ta(this.width, this.height),
          ...
          if (0 < c.length)
              ...
              m._animator.animate(200, m.animationDuration, function(a) {
                  ...
                  for (var e = 0; e < c.length; e++)
                      B = c[e],
                      1 > a && "undefined" !== typeof B.startTimePercent ? a >= B.startTimePercent && B.animationCallback(B.easingFunction(a - B.startTimePercent, 0, 1, 1 - B.startTimePercent), B) : B.animationCallback(B.easingFunction(a, 0, 1, 1), B);
      ...
      n.prototype._processMultiseriesPlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                  var t = this.data[a.dataSeriesIndexes[l]], B = 0, k = !1, m = !1, p;
                  ...
                  for (B = 0; B < t.dataPoints.length; B++) {
                      ...
                      t.dataPoints[B].x.getTime ? (f = !0,
                      b = t.dataPoints[B].x.getTime()) : b = t.dataPoints[B].x;
                      e = t.dataPoints[B].y;
                      b < c.min && (c.min = b);
                      b > c.max && (c.max = b);
                      ...
                      if (0 < B) {
                          ...
                          null !== e && null !== t.dataPoints[B - 1].y && (a.axisY.logarithmic ? (r = e / t.dataPoints[B - 1].y,
                          1 > r && (r = 1 / r),
                          d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e - t.dataPoints[B - 1].y,
                          0 > r && (r *= -1),
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], t = [], B = Infinity, k = -Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                  ...
                  if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
                      var n = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity
                  ...
                  for (q = 0; q < p.dataPoints.length; q++) {
                      ...
                      if (b < n && !g)
                          ...
                          0 <= e ? l[b] ? l[b] += e : (l[b] = e,
                          B = Math.min(e, B)) : t[b] ? t[b] += e : (t[b] = e,
                          k = Math.max(e, k)))
                      }
                  }
                  ...
                  d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, t)) : (d.dataPointYPositiveSums = l,
              ...
              for (q in l)
                  ...
                  a > d.max && (d.max = a),
                  q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, B)),
                  a > d.viewPortMax && (d.viewPortMax = a)));
              for (q in t)
                  t.hasOwnProperty(q) && !isNaN(q) && (a = t[q],
                  a < d.min && (d.min = a),
      ...
      n.prototype._processStacked100PlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, t = !1, B = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                  ...
                  for (p = 0; p < m.dataPoints.length; p++) {
                      ...
                      if (0 < p) {
                          ...
                          s(e) || null === m.dataPoints[p - 1].y || (a.axisY.logarithmic ? 0 < e && (u = e / m.dataPoints[p - 1].y,
                          1 > u && (u = 1 / u),
              ...
              d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && !t ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
              d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && t ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
              d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !l && t && (d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1),
      ...
      n.prototype._processMultiYPlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, t = !1, B = 0; B < a.dataSeriesIndexes.length; B++) {
                  var k = this.data[a.dataSeriesIndexes[B]], m = 0, p = !1, q = !1, g, r, h;
                  ...
                  for (m = 0; m < k.dataPoints.length; m++) {
                      ...
                      f < d.min && (d.min = f);
                      l > d.max && (d.max = l);
                      0 < m && (a.axisX.logarithmic ? (r = b / k.dataPoints[m - 1].x,
                      1 > r && (r = 1 / r),
                      c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = b - k.dataPoints[m - 1].x,
                      0 > r && (r *= -1),
                      c.minDiff > r && 0 !== r && (c.minDiff = r)),
                      e && (null !== e[0] && k.dataPoints[m - 1].y && null !== k.dataPoints[m - 1].y[0]) && (a.axisY.logarithmic ? (r = e[0] / k.dataPoints[m - 1].y[0],
                      1 > r && (r = 1 / r),
                      d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e[0] - k.dataPoints[m - 1].y[0],
                      0 > r && (r *= -1),
                      d.minDiff > r && 0 !== r && (d.minDiff = r))));
                      if (!(b < n) || p) {
                          if (!p && (p = !0,
          ...
          if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                  ...
                  if (t.dataPoints[B].x && t.dataPoints[B].x.getTime || "dateTime" === t.xValueType)
                      f = !0;
                  for (B = 0; B < t.dataPoints.length; B++)
                      "undefined" !== typeof t.dataPoints[B].isCumulativeSum && !0 === t.dataPoints[B].isCumulativeSum ? (t.dataPointEOs[B].cumulativeSumYStartValue = 0,
                      t.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum,
                      t.dataPoints[B].y = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum) : "undefined" !== typeof t.dataPoints[B].isIntermediateSum && !0 === t.dataPoints[B].isIntermediateSum ? (t.dataPointEOs[B].cumulativeSumYStartValue = p,
                      t.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum,
                      t.dataPoints[B].y = 0 === B ? 0 : b,
                      p = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum,
                      b = 0) : (e = "number" !== typeof t.dataPoints[B].y ? 0 : t.dataPoints[B].y,
                  ...
                  for (B = 0; B < t.dataPoints.length; B++)
                      ...
                      0 < B && (a.axisX.logarithmic ? (p = b / t.dataPoints[B - 1].x,
                      1 > p && (p = 1 / p),
                      c.minDiff > p && 1 !== p && (c.minDiff = p)) : (p = b - t.dataPoints[B - 1].x,
                      0 > p && (p *= -1),
                      c.minDiff > p && 0 !== p && (c.minDiff = p)),
                      null !== e && null !== t.dataPoints[B - 1].y && (a.axisY.logarithmic ? (e = t.dataPointEOs[B].cumulativeSum / t.dataPointEOs[B - 1].cumulativeSum,
                      1 > e && (e = 1 / e),
                      d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = t.dataPointEOs[B].cumulativeSum - t.dataPointEOs[B - 1].cumulativeSum,
                      0 > e && (e *= -1),
                      ...
                      !(b < q) || k) {
                          ...
                          b < c.viewPortMin && (c.viewPortMin = b);
                          b > c.viewPortMax && (c.viewPortMax = b);
                          0 < B && (t.dataPointEOs[B - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = t.dataPointEOs[B - 1].cumulativeSum),
              ...
              for (l = 0; l < this._axes.length; l++)
                  if (this._axes[l].dataInfo._dataRanges) {
                      ...
                      if (this._axes[l].dataInfo.dataPointYPositiveSums) {
                          ...
                          m = k;
                          for (t in q)
                              if (q.hasOwnProperty(t) && !isNaN(t) && (p = q[t],
                              !s(p))) {
                      ...
                      if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                          ...
                          m = k;
                          for (t in q)
                              q.hasOwnProperty(t) && !isNaN(t) && (p = -1 * q[t],
                              s(p) || (g = Math.floor((p - B) / b),
                              p < m[g].min && (m[g].min = p),
                              p > m[g].max && (m[g].max = p)));
          ...
          if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
              ...
              if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                  if (this.panEnabled)
                      ...
                      this.validateRegion(b, t, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(),
          ...
          for (a = 0; a < this._indexLabels.length; a++) {
              ...
              if (null !== D && "" !== D) {
                  ...
                  if ("normal" === this.plotInfo.axisPlacement) {
                      ...
                      "inside" !== A ? (e = c.y1,
                      f = c.y2,
                      0 < v ? (g = m.point.y + ("horizontal" === C ? r / 2 : 0) - k - t - b,
                      g < e && (g = "auto" === A ? Math.max(m.point.y, e) + r / 2 + t : e + r / 2 + t,
                      y = g + k > m.point.y)) : (g = m.point.y + r / 2 + t + b,
                      g > f - k && (g = "auto" === A ? Math.min(m.point.y, f) + r / 2 - k - t : f + r / 2 - k,
                      y = g < m.point.y))) : (e = Math.max(m.bounds.y1, c.y1),
                      f = Math.min(m.bounds.y2, c.y2 - k + r / 2),
                      b = 0 <= p.indexOf("range") || "error" === p ? 0 < v ? Math.max(m.bounds.y1, c.y1) + r / 2 + t : Math.min(m.bounds.y2, c.y2) + r / 2 - k + t : (Math.max(m.bounds.y1, c.y1) + Math.min(m.bounds.y2, c.y2)) / 2 - k / 2 + r / 2 + ("horizontal" === C ? t : 0),
                      0 < v ? (g = Math.max(m.point.y, b),
                      g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(m.point.y - k - t, c.y1 + t))) : (g = Math.min(m.point.y, b),
                      g > f - k - t && ("bubble" === p || "scatter" === p) && (g = Math.min(m.point.y + t, c.y2 - k - t))),
                      g = Math.min(g, f))
                  } else
                      0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? (A = "auto",
                      l = 4) : 0 <= p.indexOf("stacked") ? "auto" === A && (A = "inside") : "bubble" === p && (A = "inside"),
                      g = m.point.y + r / 2 - k / 2 + t,
                      "inside" !== A ? (e = c.x1,
                      f = c.x2,
                      0 > v ? (q = m.point.x - ("horizontal" === C ? B : B - r / 2) - l - b,
                      q < e && (q = "auto" === A ? Math.max(m.point.x, e) + l : e + l,
                      y = q + B > m.point.x)) : (q = m.point.x + ("horizontal" === C ? 0 : r / 2) + l + b,
                      q > f - B - l - b && (q = "auto" === A ? Math.min(m.point.x, f) - ("horizontal" === C ? B : B / 2) - l : f - B - l,
                      y = q < m.point.x))) : (e = Math.max(m.bounds.x1, c.x1),
                      Math.min(m.bounds.x2, c.x2),
                      b = 0 <= p.indexOf("range") || "error" === p ? 0 > v ? Math.max(m.bounds.x1, c.x1) + r / 2 + l : Math.min(m.bounds.x2, c.x2) - B / 2 - l + ("horizontal" === C ? 0 : r / 2) : (Math.max(m.bounds.x1, c.x1) + Math.min(m.bounds.x2, c.x2)) / 2 + ("horizontal" === C ? 0 : r / 2),
                  ...
                  h.y = g;
                  h.render(!0);
                  x && ("inside" !== A && (0 > p.indexOf("bar") && ("error" !== p || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2 || !y) && (0 > p.indexOf("column") && ("error" !== p || m.axisSwapped) && m.point.y > c.y1 && m.point.y < c.y2 || !y)) && (d.lineWidth = x,
                  d.strokeStyle = u ? u : "gray",
                  d.setLineDash && d.setLineDash(N(n, x)),
                  d.beginPath(),
                  d.moveTo(m.point.x, m.point.y),
                  0 <= p.indexOf("bar") || "error" === p && m.axisSwapped ? d.lineTo(q + (0 < m.direction ? -l : B + l) + ("vertical" === C ? -r / 2 : 0), g + ("vertical" === C ? -k / 2 : k / 2 - r / 2) - t) : 0 <= p.indexOf("column") || "error" === p && !m.axisSwapped ? d.lineTo(q + B / 2 - ("horizontal" === C ? 0 : r / 2), g + ("vertical" === C ? (g - k < m.point.y ? 0 : -k) + t : (g - r / 2 < m.point.y ? k : 0) - r / 2)) : d.lineTo(q + B / 2 - ("horizontal" === C ? 0 : r / 2), g + ("vertical" === C ? g - k < m.point.y ? 0 : -k : (g - r / 2 < m.point.y ? k : 0) - r / 2)),
                  d.stroke())
              }
          }
          d = {
              ...
              for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                  ...
                  if (0 < m.length) {
                      for (var C = !1, u = 0; u < m.length; u++)
                          if (x = m[u].x.getTime ? m[u].x.getTime() : m[u].x,
                          !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C)))
                              if ("number" !== typeof m[u].y)
                                  0 < u && !(k.connectNullData || C || n) && (c.stroke(),
                                  w && b.stroke()),
                                  C = !0;
                              else {
                                  ...
                                  n || C ? (!n && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(),
                                  c.beginPath(),
                                  c.moveTo(l.x, l.y),
                                  p = k.nullDataLineDashType,
                                  c.setLineDash(q)),
                                  c.lineTo(x, s),
                                  w && b.lineTo(x, s)) : (c.beginPath(),
                                  c.moveTo(x, s),
                                  w && (b.beginPath(),
                                  b.moveTo(x, s))),
                                  C = n = !1) : (c.lineTo(x, s),
                                  ...
                                  u < m.length - 1 && (h !== (m[u].lineColor || r) || p !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(),
                                  c.beginPath(),
                                  c.moveTo(x, s),
                                  h = m[u].lineColor || r,
                                  c.strokeStyle = h,
      ...
      n.prototype.renderStepLine = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                  ...
                  if (0 < m.length) {
                      for (var C = !1, u = 0; u < m.length; u++)
                          if (x = m[u].getTime ? m[u].x.getTime() : m[u].x,
                          !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C)))
                              if ("number" !== typeof m[u].y)
                                  0 < u && !(k.connectNullData || C || n) && (c.stroke(),
                                  w && b.stroke()),
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var l = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
                  ...
                  if (0 < m.length)
                      for (x = !1,
                      n = 0; n < m.length; n++)
                          if (u = m[n].getTime ? m[n].x.getTime() : m[n].x,
                          !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !x)))
                              if ("number" !== typeof m[n].y)
                                  0 < n && !x && (k.connectNullData ? b.setLineDash && (0 < s.length && (k.options.nullDataLineDashType || !m[n - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = q,
                                  ...
                                  n < m.length - 1 && (h !== (m[n].lineColor || r) || p !== (m[n].lineDashType || k.lineDashType)) && (h = m[n].lineColor || r,
                                  s[s.length - 1].newStrokeStyle = h,
                                  b.setLineDash && (m[n].lineDashType ? (p = m[n].lineDashType,
              ...
              for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                  ...
                  if (0 < r.length)
                      for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < r.length; f++)
                          if (r[f].getTime ? B = r[f].x.getTime() : B = r[f].x,
                          !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                              ...
                              var n = a.axisX.reversed ? l - p << 0 : l + p << 0, u;
                              0 <= r[f].y ? u = k : (u = t,
                              t = k);
                              t > u && (b = t,
                              t = u,
      ...
      n.prototype.renderStackedColumn = function(a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx
            , c = w ? this._preRenderCtx : d;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, f = [], l = [], t = [], B = [], k = 0, m, p, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                  ...
                  if (0 < u.length) {
                      ...
                      for (k = 0; k < u.length; k++)
                          ...
                          !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                              ...
                              var s = m - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, C = s + g << 0, D;
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)
                                  t[b] = u[k].y + (t[b] ? t[b] : 0),
                                  0 < t[b] && (p = a.axisY.convertValueToPixel(t[b]),
                  ...
                  if (0 < r.length) {
                      ...
                      for (f = 0; f < r.length; f++)
                          ...
                          !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                              ...
                              var n = a.axisX.reversed ? t - p << 0 : t + p << 0, u;
                              0 <= r[f].y ? u = k : (u = l,
                              l = k);
                              b = r[f].color ? r[f].color : g._colorSet[f % g._colorSet.length];
                  ...
                  if (0 < u.length) {
                      ...
                      for (k = 0; k < u.length; k++)
                          ...
                          !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                              ...
                              var s = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, C = s + g << 0, D;
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)
                                  t[b] = u[k].y + (t[b] ? t[b] : 0),
                                  0 < t[b] && (D = f[b] ? f[b] : q,
                  ...
                  if (0 < u.length) {
                      ...
                      for (k = 0; k < u.length; k++)
                          ...
                          !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                              ...
                              else if (m = a.axisY.convertValueToPixel(A),
                              0 <= u[k].y) {
                                  var z = f[b] ? f[b] : 0;
                                  A = q + z;
                                  m += z;
                                  ...
                                  A = m - z,
                                  m = q - z,
                                  a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.x1 - A) && (A = e.x1),
                                  l[b] = z + (m - A);
                              b = u[k].color ? u[k].color : n._colorSet[k % n._colorSet.length];
      ...
      n.prototype.renderArea = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var l = this._eventManager.ghostCtx, t = a.axisY.lineCoordinates, B = [], k = this.plotArea, m;
              f.save();
              w && l.save();
              f.beginPath();
              ...
              for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                  ...
                  B = [];
                  d = !0;
                  var h = 0, n, u, s, A = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), C, D = null;
                  if (0 < r.length) {
                      ...
                      for (var ja = !0; h < r.length; h++)
                          ...
                          !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja)))
                              if ("number" !== typeof r[h].y)
                                  ...
                                  d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = n,
                                  c = u,
                                  n = m.x,
                                  u = m.y,
                                  b(),
                                  ...
                                  h < r.length - 1 && (y !== (r[h].lineColor || v) || c !== (r[h].lineDashType || g.lineDashType)) && (b(),
                                  y = r[h].lineColor || v,
                                  f.strokeStyle = y,
                                  ...
                                  0 !== r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(h, n, u, f),
                                  B.push(s),
                                  Y = P(Y),
                                  w && B.push({
                                      x: n,
      ...
      n.prototype.renderSplineArea = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                  ...
                  l = P(l);
                  e.fillStyle = l;
                  var l = [], q = 0, g, r, h = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), n, u = null, s = [];
                  if (0 < p.length) {
                      ...
                      for (r = !1; q < p.length; q++)
                          ...
                          !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))
                              if ("number" !== typeof p[q].y)
                                  0 < q && !r && (m.connectNullData ? b.setLineDash && (0 < s.length && (m.options.nullDataLineDashType || !p[q - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = y,
                                  z = m.nullDataLineDashType) : (d(),
                                  s = [])),
                                  r = !0;
                              else {
                                  ...
                                  q < p.length - 1 && (D !== (p[q].lineColor || C) || z !== (p[q].lineDashType || m.lineDashType)) && (D = p[q].lineColor || C,
                                  s[s.length - 1].newStrokeStyle = D,
                                  b.setLineDash && (p[q].lineDashType ? (z = p[q].lineDashType,
                                  s[s.length - 1].newLineDashArray = N(z, m.lineThickness)) : (z = m.lineDashType,
                  ...
                  if (0 < r.length) {
                      ...
                      for (; h < r.length; h++)
                          ...
                          !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                              ...
                              c = !0) : (n = a.axisX.convertValueToPixel(s),
                              u = a.axisY.convertValueToPixel(r[h].y),
                              d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || Q === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = n,
                              c = u,
                              n = m.x,
                              u = m.y,
                              b(),
                              ...
                              h < r.length - 1 && (y !== (r[h].lineColor || v) || Q !== (r[h].lineDashType || g.lineDashType)) && (b(),
                              y = r[h].lineColor || v,
                              f.strokeStyle = y,
                              f.setLineDash && (r[h].lineDashType ? (Q = r[h].lineDashType,
                              f.setLineDash(N(Q, g.lineThickness))) : (Q = g.lineDashType,
                              f.setLineDash(E)))),
                              s = g.dataPointIds[h],
                              ...
                              0 !== r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (Y = g.getMarkerProperties(h, n, u, f),
                              B.push(Y),
                              s = P(s),
                              w && B.push({
                                  x: n,
      ...
      n.prototype.renderStackedArea = function(a) {
          ...
          var c = a.targetCanvasCtx || this.plotArea.ctx
            , b = w ? this._preRenderCtx : c;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = null, l = [], t = this.plotArea, h = [], k = [], m = [], p = [], q = 0, g, r, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s = this._eventManager.ghostCtx, u, x, A;
              w && s.beginPath();
              b.save();
              w && s.save();
              b.beginPath();
              ...
              b.clip();
              w && (s.beginPath(),
              s.rect(t.x1, t.y1, t.width, t.height),
              s.clip());
                      ...
                      for (var Y = !0, q = 0; q < m.length; q++) {
                          ...
                          if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y)))
                              if ("number" !== typeof fa.y)
                                  ...
                                  h[f] = n - r;
                                  x || Y ? (!x && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || A === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (x = k.pop(),
                                  A = k[k.length - 1],
                                  d(),
                                  b.moveTo(u.x, u.y),
                                  k.push(A),
                                  ...
                                  q < v.length - 1 && (Q !== (v[q].lineColor || y) || A !== (v[q].lineDashType || z.lineDashType)) && (d(),
                                  b.beginPath(),
                                  b.moveTo(g, r),
                                  k.push({
                                      x: g,
                                  ...
                                  Q = v[q].lineColor || y,
                                  b.strokeStyle = Q,
                                  b.setLineDash && (v[q].lineDashType ? (A = v[q].lineDashType,
                                  b.setLineDash(N(A, z.lineThickness))) : (A = z.lineDashType,
                                  b.setLineDash(E))));
                                  ...
                                  0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ma = z.getMarkerProperties(z.dataPointIndexes[f], g, r, b),
                                  l.push(ma),
                                  f = P(F),
                                  w && l.push({
                                      x: g,
      ...
      n.prototype.renderStackedArea100 = function(a) {
          ...
          var c = a.targetCanvasCtx || this.plotArea.ctx
            , b = w ? this._preRenderCtx : c;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = null, l = this.plotArea, t = [], h = [], k = [], m = [], p = [], q = 0, g, r, n, s, u, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), A = this._eventManager.ghostCtx;
              b.save();
              w && A.save();
              b.beginPath();
                          ...
                          if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y)))
                              if ("number" !== typeof fa.y)
                                  ...
                                  if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                      ...
                                      r = a.axisY.convertValueToPixel(ma),
                                      r -= ba;
                                  k.push({
                                      x: g,
                                      y: x - ba
                                  ...
                                  h[f] = x - r;
                                  s || Y ? (!s && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || u === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (s = k.pop(),
                                  u = k[k.length - 1],
                                  d(),
                                  b.moveTo(n.x, n.y),
                                  k.push(u),
                                  ...
                                  q < y.length - 1 && (Q !== (y[q].lineColor || E) || u !== (y[q].lineDashType || z.lineDashType)) && (d(),
                                  b.beginPath(),
                                  b.moveTo(g, r),
                                  k.push({
                                      x: g,
                                  ...
                                  Q = y[q].lineColor || E,
                                  b.strokeStyle = Q,
                                  b.setLineDash && (y[q].lineDashType ? (u = y[q].lineDashType,
                                  b.setLineDash(N(u, z.lineThickness))) : (u = z.lineDashType,
                                  b.setLineDash(F))));
                                  if (0 <= z.dataPointIndexes[f]) {
                                  ...
                                  0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ba = z.getMarkerProperties(q, g, r, b),
                                  t.push(ba),
                                  f = P(G),
                                  w && t.push({
                                      x: g,
              ...
              for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                  ...
                  if (0 < x.length)
                      for (var A = 5 < r && u.bevelEnabled ? !0 : !1, t = 0; t < x.length; t++)
                          if (x[t].getTime ? g = x[t].x.getTime() : g = x[t].x,
                          !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[t].y) && x[t].y.length && "number" === typeof x[t].y[0] && "number" === typeof x[t].y[1] && "number" === typeof x[t].y[2] && "number" === typeof x[t].y[3]) {
                              ...
                              "candlestick" === u.type ? (c.moveTo(h - y, m),
                              ...
                              b.lineTo(h - y, p),
                              b.stroke(),
                              $(b, C, Math.min(k, q), D, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(h - y, m),
                              c.lineTo(h - y, p),
                              c.stroke(),
                              c.beginPath(),
                              c.moveTo(h, k),
      ...
      n.prototype.renderBoxAndWhisker = function(a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx
            ...
            , b = this._eventManager.ghostCtx;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = this.plotArea, l = 0, t, h, k, m, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, r = a.axisX.dataInfo.minDiff;
              isFinite(r) || (r = 0.3 * Math.abs(a.axisX.range));
              ...
              for (var n = !1, n = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                  ...
                  if (0 < A.length)
                      for (var C = 5 < r && x.bevelEnabled ? !0 : !1, l = 0; l < A.length; l++)
                          if (A[l].getTime ? g = A[l].x.getTime() : g = A[l].x,
                          !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(A[l].y) && A[l].y.length && "number" === typeof A[l].y[0] && "number" === typeof A[l].y[1] && "number" === typeof A[l].y[2] && "number" === typeof A[l].y[3] && "number" === typeof A[l].y[4] && 5 === A[l].y.length) {
      ...
      n.prototype.renderRangeColumn = function(a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx
            , c = w ? this._preRenderCtx : d;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, f = 0, l, t, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                  var A = a.dataSeriesIndexes[x]
                    ...
                    , E = 0;
                  if (z)
                      for (e = C._linkedSeries.id,
                      u = 0; u < e; u++)
                          !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && E || (this.data[u].type.match(/(range)/ig) && (f = !0),
                          E++);
                  ...
                  if (0 < D.length)
                      for (var F = C._colorSet, t = 0; t < D.length; t++) {
                          ...
                          if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(D[t].y) && D[t].y.length && "number" === typeof D[t].y[0] && "number" === typeof D[t].y[1]) {
                              ...
                              b ? p = ja : g = ja;
                              b ? (q = a.axisX.reversed ? k + (z ? v : 1) * u / 2 - (z ? E - 1 : 0) * u << 0 : k - (z ? v : 1) * u / 2 + (z ? E - 1 : 0) * u << 0,
                              g = a.axisX.reversed ? q - u << 0 : q + u << 0) : (m = a.axisX.reversed ? h + (z ? v : 1) * u / 2 - (z ? E - 1 : 0) * u << 0 : h - (z ? v : 1) * u / 2 + (z ? E - 1 : 0) * u << 0,
              ...
              for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                  ...
                  if (0 < p.length) {
                      ...
                      for (var Q = !0; g < p.length; g++)
                          ...
                          !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !Q)))
                              if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                  ...
                                  q || Q ? (m.connectNullData && !q ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = E,
                                  ...
                                  g < p.length - 1 && (D !== (p[g].lineColor || C) || z !== (p[g].lineDashType || m.lineDashType)) && (d(),
                                  D = p[g].lineColor || C,
                                  h[h.length - 1].newStrokeStyle = D,
                                  b.strokeStyle = D,
                                  b.setLineDash && (p[g].lineDashType ? (z = p[g].lineDashType,
                                  h[h.length - 1].newLineDashArray = N(z, m.lineThickness),
                                  b.setLineDash(h[h.length - 1].newLineDashArray)) : (z = m.lineDashType,
                      ...
                      for (g = !1; p < m.length; p++)
                          ...
                          !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))
                              if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
                                  ...
                                  p < m.length - 1 && (A !== (m[p].lineColor || x) || C !== (m[p].lineDashType || k.lineDashType)) && (A = m[p].lineColor || x,
                                  n[n.length - 1].newStrokeStyle = A,
                                  b.setLineDash && (m[p].lineDashType ? (C = m[p].lineDashType,
                                  n[n.length - 1].newLineDashArray = N(C, k.lineThickness)) : (C = k.lineDashType,
                                  ...
                                  0 < p && !g && (k.connectNullData ? b.setLineDash && (0 < n.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType)) && (n[n.length - 1].newLineDashArray = z,
                                  C = k.nullDataLineDashType) : (d(D, x),
                                  n = [],
                                  s = [])),
                                  g = !0;
                      d(D, x);
      ...
      n.prototype.renderWaterfall = function(a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx
            , c = w ? this._preRenderCtx : d;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, l = 0, t, h, k, m, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
              ...
              for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                  ...
                  if (0 < v.length)
                      for (var A = 5 < q && s.bevelEnabled ? !0 : !1, C = !1, D = null, z = null, l = 0; l < v.length; l++)
                          if (v[l].getTime ? m = v[l].x.getTime() : m = v[l].x,
                          "number" !== typeof v[l].y) {
                              if (0 < l && !C && s.connectNullData)
                                  var y = s.options.nullDataLineDashType || !v[l - 1].lineDashType ? s.nullDataLineDashType : v[l - 1].lineDashType;
                              C = !0
                          } else {
                              ...
                              var aa, Q = t;
                              aa = "undefined" !== typeof v[l].isIntermediateSum && !0 === v[l].isIntermediateSum || "undefined" !== typeof v[l].isCumulativeSum && !0 === v[l].isCumulativeSum ? 0 < v[l].y ? h : k : 0 < v[l].y ? k : h;
                              0 < l && D && (!C || s.connectNullData) && (C && c.setLineDash && c.setLineDash(N(y, u)),
                              c.beginPath(),
                              c.moveTo(D, z - x),
                              c.lineTo(Q, aa - x),
                              0 < u && c.stroke(),
      ...
      n.prototype.renderPie = function(a) {
          ...
          function c(a) {
              ...
              for (b = 0; b < m.length; b++) {
                  ...
                  if (d > c) {
                      var e = 0.07 * z * Math.cos(g[b].midAngle)
                        ...
                        , l = !1;
                      if (m[b].exploded) {
                          if (1E-9 < Math.abs(g[b].center.x - (A.x + e)) || 1E-9 < Math.abs(g[b].center.y - (A.y + f)))
                              g[b].center.x = A.x + e * a,
                              g[b].center.y = A.y + f * a,
                              l = !0
                      } else if (0 < Math.abs(g[b].center.x - A.x) || 0 < Math.abs(g[b].center.y - A.y))
              ...
              for (b = b = 0; b < m.length; b++)
                  ...
                  "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + z * Math.cos(c.midAngle),
          ...
          function f(a, c, d) {
              ...
              if (0 <= a && a < m.length) {
                  var p = g[a];
                  if (0 > c && p.indexLabelTextBlock.y < l || 0 < c && p.indexLabelTextBlock.y > h)
                      return 0;
                  var q = 0
                    , t = 0
                    , t = q = q = 0;
                  ...
                  q = e(a);
                  h = l = 0;
                  0 > c ? (h = "right" === p.hemisphere ? t : q,
                  k = c,
                  null !== h && (t = -c,
                  c = p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - (g[h].indexLabelTextBlock.y + g[h].indexLabelTextBlock.height / 2),
                  c - t < r && (l = -t,
                  h = f(h, l, d + 1),
                  +h.toFixed(x) > +l.toFixed(x) && (k = c > r ? -(c - r) : -(t - (h - l)))))) : 0 < c && (h = "right" === p.hemisphere ? q : t,
                  k = c,
                  null !== h && (t = c,
                  c = g[h].indexLabelTextBlock.y - g[h].indexLabelTextBlock.height / 2 - (p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2),
                  c - t < r && (l = t,
                  h = f(h, l, d + 1),
                  +h.toFixed(x) < +l.toFixed(x) && (k = c > r ? c - r : t - (l - h)))));
                  k && (d = p.indexLabelTextBlock.y + k,
                  c = 0,
                  c = "right" === p.hemisphere ? A.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2)) : A.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2)),
                  p.midAngle > Math.PI / 2 - u && p.midAngle < Math.PI / 2 + u ? (l = (a - 1 + g.length) % g.length,
                  l = g[l],
                  a = g[(a + 1 + g.length) % g.length],
                  "left" === p.hemisphere && "right" === l.hemisphere && c > l.indexLabelTextBlock.x ? c = l.indexLabelTextBlock.x - 15 : "right" === p.hemisphere && ("left" === a.hemisphere && c < a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x + 15)) : p.midAngle > 3 * Math.PI / 2 - u && p.midAngle < 3 * Math.PI / 2 + u && (l = (a - 1 + g.length) % g.length,
                  l = g[l],
                  a = g[(a + 1 + g.length) % g.length],
                  "right" === p.hemisphere && "left" === l.hemisphere && c < l.indexLabelTextBlock.x ? c = l.indexLabelTextBlock.x + 15 : "left" === p.hemisphere && ("right" === a.hemisphere && c > a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x - 15)),
          ...
          function l() {
              ...
              for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                  if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && z - d <= y)
                      l = !1;
                  l && (z -= d);
                  d = 0;
                          ...
                          if (null !== s) {
                              ...
                              if (0 > C) {
                                  for (var D = u = 0, F = 0; F < m.length; F++)
                                      F !== a && g[F].hemisphere === h.hemisphere && (g[F].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? u++ : D++);
                                  u = C / (u + D || 1) * D;
                                  var D = -1 * (C - u)
                                    , J = F = 0;
                                  "right" === h.hemisphere ? (F = f(a, u),
                                  D = -1 * (C - F),
                                  J = f(s, D),
                                  +J.toFixed(x) < +D.toFixed(x) && +F.toFixed(x) <= +u.toFixed(x) && f(a, -(D - J))) : (F = f(s, u),
                                  D = -1 * (C - F),
                                  J = f(a, D),
                                  +J.toFixed(x) < +D.toFixed(x) && +F.toFixed(x) <= +u.toFixed(x) && f(s, -(D - J)))
                              }
                          }
                      }
                  } else
                  ...
                  for (a = 0; a < m.length; a++)
                      ...
                      0 !== s.height && 0 !== s.width)
                          s = s = 0,
                          "right" === h.hemisphere ? (s = q.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p),
                          s *= -1) : s = q.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p),
                          0 < s && (!l && h.indexLabelText && (u = "right" === h.hemisphere ? q.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - q.x1,
                          ...
                          Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - A.y) < z || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - A.y) < z) && (s /= Math.abs(Math.cos(h.indexLabelAngle)),
                          9 < s && (s *= 0.3),
                          s > d && (d = s)),
                          s = s = 0,
                          0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? (s = q.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5),
                          s *= -1) : s = q.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5),
                          0 < s && (!l && h.indexLabelText && (u = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1,
                          0 === f(a, s * u) && f(a, 2 * u)),
                          Math.abs(h.indexLabelTextBlock.x - A.x) < z && (s /= Math.abs(Math.sin(h.indexLabelAngle)),
                          9 < s && (s *= 0.3),
                          s > d && (d = s)));
          ...
          var n = this;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var k = this.data[a.dataSeriesIndexes[0]], m = k.dataPoints, p = 10, q = this.plotArea, g = k.dataPointEOs, r = 2, w, v = 1.3, u = 20 / 180 * Math.PI, x = 6, A = {
                  x: (q.x2 + q.x1) / 2,
                  y: (q.y2 + q.y1) / 2
              }, C = 0;
              a = !1;
              ...
              if (0 !== C) {
                  ...
                  this.pieDoughnutClickHandler = function(a) {
                      n.isAnimating || !s(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint,
      ...
      n.prototype.renderFunnel = function(a) {
          ...
          function c() {
              ...
              for (var l = d[0] = 0, h = 0, m, p, b = b - a, l = !1, k = 0; k < x.length; k++)
                  ...
                  l ? m = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = $ * $ * b * b - 4 * Math.abs($) * a,
                  0 > p ? (p = c,
                  l = (b + p) * (e - h) / 2,
                  a -= l,
                  m = e - h,
                  ...
                  m += 0 == p ? 0 : a / p,
                  h += a / p,
                  l = !0) : (m = (Math.abs($) * b - Math.sqrt(p)) / 2,
                  p = b - 2 * m / Math.abs($),
                  h += m,
                  h > e && (h -= m,
                  p = c,
          ...
          function b() {
              if (u && x) {
                  for (var a, b, c, d, e, f, k, l, h, m, p, q, t, n, r, B = [], v = [], A = {
                      percent: null,
                      total: null
                  }, C = null, z = 0; z < x.length; z++)
                      r = O[z],
                      r = "undefined" !== typeof r.x5 ? (r.y2 + r.y4) / 2 : (r.y2 + r.y3) / 2,
                      r = g(r).x2 + 1,
                      B[z] = M - r - U;
                  r = 0.5 * U;
                  for (var z = 0, D = x.length - 1; z < x.length || 0 <= D; z++,
                  D--) {
                      ...
                      "inside" === u.indexLabelPlacement && (B[z] = z !== ca ? u.reversed ? O[z].x2 - O[z].x1 : O[z].x3 - O[z].x4 : O[z].x3 - O[z].x6,
                      20 > B[z] && (B[z] = z !== ca ? u.reversed ? O[z].x3 - O[z].x4 : O[z].x2 - O[z].x1 : O[z].x2 - O[z].x1,
                      B[z] /= 2));
          ...
          function e() {
              ...
              if (e)
                  for (l = I.length - 1; 0 <= l; l--)
                      ...
                      u.reversed ? (I[l].textBlock.y + I[l].height > na + C && (I[l].textBlock.y = na + C - I[l].height),
                      I[l].textBlock.y < sa - C && (I[l].textBlock.y = sa - C)) : (I[l].textBlock.y < na - C && (I[l].textBlock.y = na - C),
                      I[l].textBlock.y + I[l].height > sa + C && (I[l].textBlock.y = sa + C - I[l].height))
          }
          function f() {
              var a, b, c, d;
              if ("inside" !== u.indexLabelPlacement)
                  for (var e = 0; e < O.length; e++)
                      ...
                      c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2,
                      b = u.reversed ? "undefined" !== typeof a.x5 ? c > xa ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < xa ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1,
                      I[e].textBlock.x = b + U,
                      I[e].textBlock.y = c - I[e].height / 2,
                      u.reversed ? (I[e].textBlock.y + I[e].height > na + C && (I[e].textBlock.y = na + C - I[e].height),
                      I[e].textBlock.y < sa - C && (I[e].textBlock.y = sa - C)) : (I[e].textBlock.y < na - C && (I[e].textBlock.y = na - C),
                      I[e].textBlock.y + I[e].height > sa + C && (I[e].textBlock.y = sa + C - I[e].height)));
              else
          ...
          function l() {
              ...
              function b() {
                  ...
                  for (var k, h = 1; h < l; h++) {
                      ...
                      for (var t = I.length - 1; 0 <= t; t--)
                          !I[t].isDirty && (I[t].textBlock.y < e && I[t].textBlock.y + I[t].height > e) && (k = q(t),
                          !(k >= I.length - 1) && I[t].textBlock.y + I[t].height + da > I[k].textBlock.y && (I[t].textBlock.y = I[t].textBlock.y + I[t].height - e > e - I[t].textBlock.y ? e + 1 : e - I[t].height - 1))
                  }
              ...
              for (var d, e, f, g, l, k, m = 1, n = 0; n < 2 * m; n++) {
                  ...
                  e = +g.y.toFixed(6),
                  !f.isDirty && (l && e + d + da > +k.y.toFixed(6)) && (d = g.y + d + da - k.y,
                  e = a(r, -d),
                  e < d && (0 < e && (d -= e),
                  e = a(q(r), d),
                  e != d))); r--)
          ...
          function n(a, b, c) {
              ...
              a._animator.animate(0, c, function(c) {
                  ...
                  for (e = 0; e < O.length; e++)
                      pa(d, O[e], u.fillOpacity);
                  v(d);
                  J && ("inside" !== u.indexLabelPlacement ? m(d) : f(),
                  r(d));
                  1 <= c && (ha = !1)
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              for (var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, A = this.plotArea, C = 0.025 * A.width, D = 0.01 * A.width, z = 0, E = A.height - 2 * C, F = Math.min(A.width - 2 * D, 2.8 * A.height), J = !1, H = 0; H < x.length; H++)
                  if (!J && ("undefined" !== typeof x[H].indexLabel && null !== x[H].indexLabel && 0 < x[H].indexLabel.toString().length) && (J = !0),
              ...
              if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                  ...
                  var D = H + a / 2
                    ...
                    , sa = u.reversed ? Y : P;
                  a = [];
                  var D = [], O = [], F = [], Z = Y, ca, $ = (xa - na) / (L - W), ea = -$, H = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? c() : d();
                  if (-1 !== H) {
                      if (u.reversed)
                          for (F.push(Z),
                          G = H.length - 1; 0 < G; G--)
                      ...
                      if (u.reversed)
                          for (G = 0; G < H.length; G++)
                              F[G] < xa ? (a.push(L),
                              D.push(V),
                              ca = G) : (a.push((F[G] - na + $ * W) / $),
                              D.push((F[G] - na + ea * T) / ea));
                      else
                          for (G = 0; G < H.length; G++)
                              F[G] < xa ? (a.push((F[G] - na + $ * W) / $),
                              D.push((F[G] - na + ea * T) / ea),
                              ca = G) : (a.push(L),
                              D.push(V));
                      ...
                      for (G = 0; G < x.length; G++)
                          x[G].exploded && (H = !0,
                          u.reversed ? X.push(x.length - 1 - G) : X.push(G));
                      ...
                      for (G = 0; G < O.length; G++)
                          z = O[G],
                          pa(R, z, u.fillOpacity),
                          ga.push(z.y1);
                      v(R);
                      J && u.visible && ("inside" === u.indexLabelPlacement || y.animationEnabled || m(R),
                      ...
                      this.funnelPyramidClickHandler = function(a) {
                          var b = -1;
                          if (!ha && !y.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = u.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex,
                          0 <= b)) {
                              a = b;
              ...
              if ("x" === a)
                  if (c.axisX && "dateTime" === c.axisX.valueType || "dateTime" === c.xValueType || d.x && d.x.getTime) {
                      if (!c.axisX.logarithmic)
                          return Aa(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString : "DD MMM YY", f._cultureInfo)
                  } else
                  ...
                  if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                      ...
                      for (var x = 0; x < p.dataPoints.length; x++) {
                          var A = p.dataPoints[x]
                            ...
                            , g = A.legendText ? A.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                              chart: this.chart,
                              legend: this.options,
                              dataSeries: p,
                              dataPoint: A
                            ...
                            , u = A.legendMarkerBorderThickness ? A.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : A.markerBorderThickness || p.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0
      ...
      F.prototype.render = function() {
          ...
          for (var h = 0, n = 0; n < l.length; n++) {
              for (var k = l[n], m = 0, p = 0; p < k.items.length; p++) {
                  ...
                  V.drawMarker(g + f / 2, r + this.lineHeight / 2, this.ctx, q.markerType, "error" === q.chartType || "line" === q.chartType || "spline" === q.chartType ? q.markerSize / 2 : q.markerSize, q.markerColor, q.markerBorderColor, q.markerBorderThickness);
                  q.textBlock.x = g + c + f;
                  if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType)
              ...
              if (0 <= f && f < this.dataPoints.length) {
                  ...
                  if (q) {
                      ...
                      case "doughnut":
                          ...
                          r < q.radius && r > w && (r = Math.atan2(d - s.y, a - s.x),
                          0 > r && (r += 2 * Math.PI),
          ...
          if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
              ...
              if (this.logarithmic && !this.equidistantInterval)
                  ...
                  g = q; b < this.logLabelValues.length; b++)
                      ...
                      c < this.viewportMinimum)
                          ...
                          }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : ea(m, this.valueFormatString, this.chart._cultureInfo),
                          a = new ia(this.ctx,{
                              x: 0,
                              y: 0,
                              maxWidth: f,
              ...
              c = this.intervalStartPosition; c < e; Va(c, b, this.intervalType)) {
                  ...
                  a || (a = this.labelFormatter ? this.labelFormatter({
                      ...
                      value: new Date(m),
                      label: this.labels[m] ? this.labels[m] : null
                  }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : Aa(m, this.valueFormatString, this.chart._cultureInfo),
                  a = new ia(this.ctx,{
                      x: 0,
                      y: 0,
                      maxWidth: f,
                          ...
                          if (!this._labels[c].breaksLabelType) {
                              ...
                              if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                  ...
                                  !s(this.options.labelWrap))
                                      this.labelWrap ? s(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), m),
                                      this.sessionVariables.labelWrap = this.labelWrap,
                                  ...
                                  this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : m) : (s(this.options.labelMaxWidth),
                                  this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : m,
                                  this.sessionVariables.labelWrap = this.labelWrap),
                                  this.sessionVariables.labelMaxHeight = l)
                          }
      ...
      E.setLayout = function(a, d, c, b, e, f) {
          ...
          for (g = 0; g < q.length; g++)
              if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
                  for (var r = q[g].scaleBreaks._appliedBreaks, w = 0; w < r.length && !(r[w].startValue > q[g].viewportMaximum); w++)
                      r[w].endValue < q[g].viewportMinimum || (s(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w),
          ...
          if ("normal" === e) {
              for (var x = [], A = [], y = [], D = [], M = [], N = [], P = [], R = []; 4 > w; ) {
                  ...
                  if (a && 0 < a.length)
                      for (g = 0; g < a.length; g++)
                          ...
                          !a[g] || (!a[g].labelAutoFit || s(z) || s(E) || m.isNavigator || m.stockChart) || (h = 0,
                          0 < a[g].labelAngle ? E + u > n && (h += 0 < a[g].labelAngle ? E + u - n - $ : 0) : 0 > a[g].labelAngle ? z - v < l && z - v < a[g].viewportMinimum && (F = l - (L + a[g].tickLength + y + z - v + a[g].labelFontSize / 2)) : 0 === a[g].labelAngle && (E + u > n && (h = E + u / 2 - n - $),
                          z - v < l && z - v < a[g].viewportMinimum && (F = l - L - a[g].tickLength - y - z + v / 2)),
                          a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < h ? n -= h : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < F ? l += F : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < F && (l += F),
                          0 < h && (n -= h))),
                  ...
                  if (b && 0 < b.length)
                      for (g = 0; g < b.length; g++)
                          ...
                          "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (D[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2,
                  ...
                  if (a && 0 < a.length)
                      for (g = 0; g < a.length; g++)
                          ...
                          a[g]._labels && 1 < a[g]._labels.length && (z = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1,
                          l = a[g]._labels[a[g]._labels.length - ("dateTime" === a[g].valueType ? 2 : 1)].position,
                          l = a[g].getApparentDifference(a[g].viewportMinimum, l),
                          E = a[g].logarithmic ? (1 < l ? Math.log(l) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1));
                  if (d && 0 < d.length)
                      for (g = 0; g < d.length; g++)
                          d[g].calculateValueToPixelConversionParameters(),
                          d[g].calculateBreaksSizeInValues(),
                          d[g]._labels && 1 < d[g]._labels.length && (z = (d[g].logarithmic ? Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1,
                          l = d[g]._labels[d[g]._labels.length - ("dateTime" === d[g].valueType ? 2 : 1)].position,
                          l = d[g].getApparentDifference(d[g].viewportMinimum, l),
                          E = d[g].logarithmic ? (1 < l ? Math.log(l) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1);
                  for (g = 0; g < q.length; g++)
              ...
              for (N = []; 4 > w; ) {
                  ...
                  if (m.panEnabled)
                      for (g = 0; g < c.length; g++)
                          p[g] = s(m.sessionVariables.axisY.height) ? m.sessionVariables.axisY.height = p[g] : m.sessionVariables.axisY.height;
                  else
                      for (g = 0; g < c.length; g++)
                      ...
                      for (g = 0; g < a.length; g++) {
                          ...
                          if (c && 0 < c.length)
                              for (L = 0; L < c.length; L++)
                                  c[L] && c[L].labelAutoFit && (n = 0 > c[L].labelAngle ? Math.max(n, x) : 0 === c[L].labelAngle ? Math.max(n, x / 2) : n,
      ...
      E.prototype.calculateAxisParameters = function() {
          if (this.logarithmic)
              ...
              if ("axisX" === this.type && c) {
                  ...
                  this.intervalType = "month") : (this.interval = b / (1 * R.yearDuration) <= a ? 1 : b / (2 * R.yearDuration) <= a ? 2 : b / (4 * R.yearDuration) <= a ? 4 : Math.floor(E.getNiceNumber(b / (a - 1), !0) / R.yearDuration),
      ...
      E.prototype.calculateLogarithmicAxisParameters = function() {
          ...
          this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = E.getNiceExponent(Math.log(l) / d / (a - 1), !0),
          ...
          this.options && "undefined" === typeof this.options.interval && (this.interval = E.getNiceExponent(Math.ceil(Math.log(l) / d) / (a - 1)),
      ...
      ca.prototype.render = function(a) {
          if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
              ...
              if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                  ...
                  n = this.chart.plotArea.y2 + p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2,
          ...
          if (this.snapToDataPoint) {
              ...
              if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                  ...
                  for (var y = 0; y < this.parent.dataSeries.length; y++)
                      (v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[y],
                      ...
                      for (var v = Math.abs(a - this.parent.convertValueToPixel(m[y].dataPoint.y[0])), u = 0, r = 0; r < m.length; r++)
                          if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                              for (var x = 0; x < m[r].dataPoint.y.length; x++)
                                  u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[x])),
                                  u < v && (v = u,
                                  y = r);
                          else
                  ...
                  if ("bottom" === this.parent._position || "top" === this.parent._position) {
                      ...
                      if ("rangeBar" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type) {
                          ...
                          for (r = u = 0; r < x.dataPoint.y.length; r++)
                              u = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[r])),
                              u < v && (v = u,
                              b = r);
                      ...
                      if (C) {
                          if ("axisX" === this.parent.type)
                              ...
                              y = 0; y < this.parent.dataSeries.length; y++)
                                  (v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({
                                      chart: this.chart,
                                      axis: this.parent.options,
                                      crosshair: this.options,
                                      value: x.dataPoint.x
                  ...
                  if ("rangeColumn" === m[0].dataSeries.type || "rangeArea" === m[0].dataSeries.type || "error" === m[0].dataSeries.type || "rangeSplineArea" === m[0].dataSeries.type || "candlestick" === m[0].dataSeries.type || "ohlc" === m[0].dataSeries.type || "boxAndWhisker" === m[0].dataSeries.type)
                      ...
                      r = u = 0; r < m.length; r++)
                          if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                              for (x = 0; x < m[r].dataPoint.y.length; x++)
                                  u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[x])),
                                  u < v && (v = u,
                                  y = r);
                          else
                  ...
                  if ("rangeColumn" === this.parent.dataSeries[y].type || "rangeArea" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type || "rangeSplineArea" === this.parent.dataSeries[y].type || "candlestick" === this.parent.dataSeries[y].type || "ohlc" === this.parent.dataSeries[y].type || "boxAndWhisker" === this.parent.dataSeries[y].type) {
                      ...
                      for (r = u = 0; r < x.dataPoint.y.length; r++)
                          u = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[r])),
                          u < v && (v = u,
                          b = r);
                      ...
                      "waterfall" === this.parent.dataSeries[y].type ? (w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0,
                      k.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
                      ...
                      this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (w = 1 === q.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0,
                      k.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
                  ...
                  if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                      ...
                      if (this.chart.axisX)
                          for (v = 0; v < this.chart.axisX.length; v++)
                              ...
                              k = null,
                              b = 0; b < this.chart.axisX[v].dataSeries.length; b++)
                                  (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b],
                                  null !== k.dataPoint.y && n.push(k));
                      if (this.chart.axisX2)
                          for (v = 0; v < this.chart.axisX2.length; v++)
                              ...
                              k = null,
                              b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)
                                  (k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b],
                                  null !== k.dataPoint.y && n.push(k))
                  }
                  if (0 === n.length)
      ...
      W.prototype.highlightObjects = function(a) {
          ...
          for (c = 0; c < a.length; c++) {
              ...
              if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                  ...
                  f.borderColor = f.borderColor || "#FFFFFF",
                  f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size),
                  V.drawMarkers([f]))) : "bubble" === b.type ? (f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx),
                  f.size = e.size,
                  f.color = "white",
                  f.borderColor = "white",
                  d.globalAlpha = 0.3,
                  V.drawMarkers([f]),
                  d.globalAlpha = 1) : "column" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "bar" === b.type || "rangeBar" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "rangeColumn" === b.type || "waterfall" === b.type ? $(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? ga(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? pa(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1,
                  ...
                  d.stroke()),
                  d.beginPath(),
                  $(d, e.x1 - e.borderThickness / 2, Math.max(e.y2 + e.borderThickness / 2, e.y3 + e.borderThickness / 2), e.x2 + e.borderThickness / 2, Math.min(e.y2 - e.borderThickness / 2, e.y3 - e.borderThickness / 2), "transparent", e.borderThickness, e.color, !1, !1, !1, !1),
                  d.globalAlpha = 1,
      ...
      W.prototype.getToolTipInnerHTML = function(a) {
          ...
          if (h && (this.content && "function" === typeof this.content || this.contentFormatter))
              ...
              for (var s = null, k = "", n = 0; n < a.length; n++)
                  ...
                  e = a[n].index,
                  f = "",
                  0 === n && (h && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? k += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ? this.chart.axisX[0].labels[b.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length && (k += "undefined" !== typeof this.chart.axisX2[0].labels[b.x] ? this.chart.axisX2[0].labels[b.x] : "{x}"),
                  k += "</br>",
                  ...
                  n < a.length - 1 && (d = "</br>" + d)) : (d += this.chart.replaceKeywordsWithValue(f, b, c, e),
                  n < a.length - 1 && (d += "</br>")));
              null !== d && (d = k + d)
          } else {
              c = a[0].dataSeries;
